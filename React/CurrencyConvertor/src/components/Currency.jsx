  ...
  return (
    <>
      <div className="bg-amber-50 h-screen p-5">
        <div className="w-3xl bg-white rounded shadow border p-2 mx-auto space-y-5">
          <div className="relative grid grid-cols-2 gap-10">
            ...
            <div className="absolute left-1/2 -translate-x-[50%] top-3 ">
                <button
                className="text-2xl hover:scale-150 hover:duration-300 scale-100 duration-300 hover:text-green-500  " onClick={swap}> <AiOutlineSwap /></button>
            </div>
